...
\fancyhead[RO,LE]{\textbf{IA aplicada a Negocios} \leftmark }
\fancyfoot{} % clear all footer fields
\fancyfoot[RO,LE]{Juan Gabriel Gomila - Frogames Formación}
...
\begin{Highlighting}[]
    ...
    \KeywordTok{def}\NormalTok{ reset(}\VariableTok{self}\NormalTok{, new\_month):}
        \VariableTok{self}\NormalTok{.atmospheric\_temperature }\OperatorTok{=} \VariableTok{self}\NormalTok{.monthly\_atmospheric\_temperatures[new\_month]}
