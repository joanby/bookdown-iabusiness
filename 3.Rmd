...
# Maximizando los ingresos de un negocio minorista en línea
# con el muestreo de Thompson
...
![](Images/Regret_Curve_Random_Strategy.png)
...
![](Images/Regret_Curve_Thompson_Sampling.png)
...
# Implementación de la estrategia aleatoria y del muestreo de Thompson
# con la curva de arrepentimiento
strategies_selected_rs = []
strategies_selected_ts = []
total_reward_rs = 0
total_reward_ts = 0
